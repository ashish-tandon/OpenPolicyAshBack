...
# 🚀 Simple Azure Deployment Script for OpenPolicy
# This script provides a step-by-step deployment with user interaction
...
# Main function
main() {
    echo "🚀 Starting Simple Azure deployment for OpenPolicy"
    echo "Resource Group: $RESOURCE_GROUP"
